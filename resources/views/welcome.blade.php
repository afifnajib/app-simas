        ...
        <div class="isolate bg-white">
            ...
            <div class="px-6 pt-6 lg:px-8">
                ...
                <div class="flex lg:hidden">
                    <button type="button" class="toggle-open -m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700 cursor-pointer ease-out duration-300">
            ...
            <main>
                ...
                <div class="mx-auto max-w-2xl py-20 sm:py-25 lg:py-32">
...
<script>
    ...
    tOpen.addEventListener('click', () => {
        ...
        // tOpen.click ? tOpen.classList.add("hidden") : tOpen.classList.remove("visibility");
        // to.click ? tc.classList.add('visibility') : to.classList.remove('hidden');
    });
